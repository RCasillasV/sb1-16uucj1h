          ...
          <div className="overflow-x-auto">
            <table className="min-w-full">
              <thead>
                ...
                >
                  <th className="px-4 py-3 text-left text-sm font-medium" style={{ color: currentTheme.colors.textSecondary }}>
                    Parentesco
                  </th>
                  <th className="px-4 py-3 text-left text-sm font-medium" style={{ color: currentTheme.colors.textSecondary }}>
                    Estado Vital
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <input
                          ...
                          placeholder="Edad"
                          className="w-20 p-2 text-sm rounded-md border"
                          style={{
                            background: currentTheme.colors.surface,
                            borderColor: currentTheme.colors.border,
                            color: currentTheme.colors.text,
