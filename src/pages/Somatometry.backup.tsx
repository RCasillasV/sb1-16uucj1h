...
return (
    <div className="space-y-1" style={{ fontSize: 'var(--user-font-size-percentage, 100%)' }}>
      ...
      {error && (
        <div className="p-2 rounded-md border-l-4" style={{
          background: '#FEE2E2',
          borderColor: '#DC2626',
          color: '#DC2626',
          marginBottom: '0.5rem'
      ...
      <div className="rounded-lg shadow-sm overflow-hidden" style={{ background: currentTheme.colors.surface }}>
        <div className="flex items-stretch border-b overflow-x-auto" style={{ borderColor: currentTheme.colors.border, minHeight: '42px' }}>
                  ...
                  <table className="w-full text-base">
                    <thead>
                      ...
                      >
                        ...
                        <th
                          className="text-left py-2.5 px-3 text-sm font-medium uppercase tracking-wider"
                          style={{ 
                            color: currentTheme.colors.textSecondary,
                            fontSize: '0.9em'
                          }}
                        ...
                        <th
                          className="text-center py-2 px-3 text-xs font-medium uppercase tracking-wider"
                          style={{ color: currentTheme.colors.textSecondary }}
                        >
                          Acciones
                        </th>
          ...
          {activeTab === 'weight' && records.length > 0 && (
            <div>
              <WHOWeightForAgeFromDB 
                records={records}
                gender={(selectedPatient.Sexo === 'Femenino' || selectedPatient.Sexo === 'F' || selectedPatient.Sexo === 'Mujer') ? 'F' : 'M'}
          ...
          {activeTab === 'height' && records.length > 0 && (
            <div>
              <h3
                ...
                style={{ color: currentTheme.colors.text }}
              >
                Gráfica de Talla para la Edad - OMS
              </h3>
          ...
          {activeTab === 'bmi' && records.length > 0 && (
            <div>
              <h3
                ...
                style={{ color: currentTheme.colors.text }}
              >
                Gráfica de IMC para la Edad - OMS
              </h3>
              <WHOBMIForAgeFromDB 
                records={records}
                gender={(selectedPatient.Sexo === 'Femenino' || selectedPatient.Sexo === 'F' || selectedPatient.Sexo === 'Mujer') ? 'F' : 'M'}
          ...
          {activeTab === 'head' && records.length > 0 && (
            <div>
              <h3
                ...
                style={{ color: currentTheme.colors.text }}
              >
                Gráfica de Perímetro Cefálico para la Edad - OMS
              </h3>
