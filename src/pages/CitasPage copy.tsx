  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      if (editingAppointment) {
        ...
        // Detectar si el estado cambió para registrar en historial
        const newStatusId = Number(data.estado) !== editingAppointment.estado 
          ? Number(data.estado) 
          : undefined;
        
        if (newStatusId) {
          console.log('✅ Estado cambió de', editingAppointment.estado, 'a', newStatusId, '- Se registrará en historial');
        }
        
        await api.appointments.update(editingAppointment.id, updatePayload, newStatusId);
      } else {
