...
export function SomatometryForm({ 
  ...
  const ageMonths = useMemo(() => {
    const calculatedAge = somatometryService.calculateAgeInMonths(
  ...
  const detailedAge = useMemo(() => {
    // Si hay error de fecha, devolver edad cero
    if (ageMonths === 0 && dateError) {
  ...
  }, [patient.FechaNacimiento, formData.measurement_date, ageMonths, dateError]);
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 
              ...
              style={{ 
                color: currentTheme.colors.text,
                fontFamily: currentTheme.typography?.fonts?.headings || 'inherit',
              }}
            >
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            style={{
              ...inputStyle,
              borderColor: dateError ? '#DC2626' : inputStyle.borderColor,
            }}
            required
        ...
        <div className="flex justify-end space-x-3 pt-6">
          ...
          <button
            type="submit"
            disabled={loading || validationErrors.length > 0 || !!dateError || ageMonths < 0}
            className={clsx(
              "px-6 py-2 rounded-md transition-colors flex items-center gap-2",
              (loading || validationErrors.length > 0 || !!dateError || ageMonths < 0) && "opacity-50 cursor-not-allowed"
            )}
            style={{
