                    ...
                    <div className="mb-2 p-2 rounded text-xs" style={{ background: `${currentTheme.colors.primary}10` }}>
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <div className="flex items-center gap-2" style={{ color: currentTheme.colors.text }}>
                          <span className="font-medium opacity-70">Anterior:</span>
                          <span>{formatDateTime(entry.fecha_anterior, entry.hora_anterior)}</span>
                          <span className="opacity-50">→</span>
                          <span className="font-medium opacity-70">Nueva:</span>
                          <span>{formatDateTime(entry.fecha_nueva, entry.hora_nueva)}</span>
                        </div>
                      </div>
                    </div>
                  )}
