...
import { Users, Calendar, CalendarDays, LayoutDashboard, FileText, Activity, Settings as SettingsIcon, LogOut, Stethoscope, NotebookTabs, FileSpreadsheet, FolderOpen, UserSquare as RulerSquare } from 'lucide-react';
