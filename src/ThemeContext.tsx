...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  const cssVariables = useMemo(() => {
    ...
    // Fonts
    vars['--font-headings'] = `"${currentTheme.typography.fonts.headings}", sans-serif`;
    vars['--font-subheadings'] = `"${currentTheme.typography.fonts.subheadings}", sans-serif`;
    vars['--font-body'] = `"${currentTheme.typography.fonts.body}", sans-serif`;
    vars['--font-ui'] = `"${currentTheme.typography.fonts.ui}", sans-serif`;
